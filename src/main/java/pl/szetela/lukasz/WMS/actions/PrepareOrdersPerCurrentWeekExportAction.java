...
@Component
public class PrepareOrdersPerCurrentWeekExportAction extends AbstractPrepareOrdersAction {
    ...
    @Autowired
    public PrepareOrdersPerCurrentWeekExportAction(UserService userService, OrderService orderService) {
        super(userService);
